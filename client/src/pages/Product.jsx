...
const Product = () => {
    ...
    return productData ? (
        <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
            {/* Product Data */}
            <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row px-20'>
                {/* Product Images */}
                ...
                <div className='flex-1'>
                    ...
                    {/* <p className='mt-5 text-gray-500 md:wd-4/5'>{productData.description}</p> */}
            ...
            <div className='mt-20 px-20'>
                ...
                <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
                    ...
                    {/* Here we use `productData.fullDescription` instead of Lorem ipsum */}
                </div>
            </div>
